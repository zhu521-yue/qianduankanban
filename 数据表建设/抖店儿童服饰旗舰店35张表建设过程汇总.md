...
客户周、月、季度、半年拿货次数统一改为客户ID在`customer_daily_sales`中的出现次数，即有效拿货天数。正式重载后4张表行数分别为14,879、8,617、6,256、5,237，单周期最大值分别为7、31、91、177；`customer_health_detail`同步重算5,237行，逐业务键差异为0。
